...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        iqphoto1 = await iqthon.upload_file(file="SQL/extras/Heahthon.jpg")
        _, groupid = await create_supergroup(            "تخزين تليثون الجمهورية العام", iqthon, Config.TG_BOT_USERNAME, descript  ,  iqphoto1 )
