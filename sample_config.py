...
class Config(object):
    LOGGER = True
    ALIVE_NAME = os.environ.get("ALIVE_NAME", "@CDCTOP")
    ...
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/HeaThon/Arab")
    AUTONAME = os.environ.get("AUTONAME", "@CDCTOP")
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "cdctop")
    THUMB_IMAGE = os.environ.get("THUMB_IMAGE", "https://telegra.ph/file/d85f9e2d344d9e086ec52.jpg")
